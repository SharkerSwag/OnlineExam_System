/*
 ...
 Source Server         : 腾讯云mysql8.0
 Source Server Type    : MySQL
 Source Server Version : 80029
 Source Host           : 101.43.16.92:3307
...
-- ----------------------------
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RenrenScheduler', 'DESKTOP-8QA7ISJ1676954149803', 1676956237847, 15000);
...
-- ----------------------------
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RenrenScheduler', 'TASK_1', 'DEFAULT', 'TASK_1', 'DEFAULT', NULL, 1676957400000, 1676955600000, 5, 'WAITING', 'CRON', 1673006532000, 0, NULL, 2, );
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '年级班级' ROW_FORMAT = Dynamic;
...
CREATE TABLE `exam_major`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '专业' ROW_FORMAT = Dynamic;
...
CREATE TABLE `exam_paper`  (
  ...
  `subject_id` int(0) NULL DEFAULT NULL COMMENT '课程科目',
  `answer_num` int(0) NULL DEFAULT NULL COMMENT '答题次数',
  ...
  `exam_time` int(0) NULL DEFAULT NULL COMMENT '考试时间（分）',
...
CREATE TABLE `exam_paper_clazz`  (
  ...
  `clazz_id` int(0) NULL DEFAULT NULL COMMENT '班级id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '试卷分配给班级' ROW_FORMAT = Dynamic;
...
CREATE TABLE `exam_paper_question`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 201 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '试卷与题目关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `exam_paper_record`  (
  ...
  `correct_num` int(0) NULL DEFAULT NULL COMMENT '正确数',
  `exam_score` float(10, 1) NULL DEFAULT NULL COMMENT '考试得分',
  `is_checked` int(0) NULL DEFAULT 0 COMMENT '0: 改卷中 -1: 未及格 -2 未参加考试， 1 及格',
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '描述',
  `is_deleted` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0 COMMENT '逻辑删除0未删除1以删除',
  `create_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `exam_question`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `question_type_id` int(0) NULL DEFAULT NULL COMMENT '题目类型id',
  `subject_id` int(0) NULL DEFAULT NULL COMMENT '课程科目id',
  ...
  `difficulty` int(0) NULL DEFAULT NULL COMMENT '题目难度',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 160 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '题目' ROW_FORMAT = Dynamic;
...
CREATE TABLE `exam_question_record`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1137 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '考试记录 题目记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `exam_question_type`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '题目类型' ROW_FORMAT = Dynamic;
...
CREATE TABLE `exam_student`  (
  ...
  `clazz` int(0) NULL DEFAULT NULL COMMENT '班级',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '学生信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `exam_subject`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '课程科目表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of exam_subject
-- ----------------------------
INSERT INTO `exam_subject` VALUES (1, '计算机网络', '测试', 0, '5201314', '', '2023-01-07 13:54:28', NULL);
INSERT INTO `exam_subject` VALUES (2, '数据结构', 'cscs', 0, '5201314', '000000', '2023-01-07 13:55:08', '2023-02-21 12:42:46');
...
) ENGINE = InnoDB AUTO_INCREMENT = 341 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '定时任务日志' ROW_FORMAT = Dynamic;
...
INSERT INTO `schedule_job_log` VALUES (341, 1, 'testTask', 'renren', 0, NULL, 3, '2023-02-21 13:00:01');
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 344 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色与菜单对应关系' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `sys_user_token` VALUES (1, 'fd2869b04fbe58deef126903465fae6b', '2023-02-22 00:56:04', '2023-02-21 12:56:04');
